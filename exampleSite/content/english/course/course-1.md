...
### Courses: levels, duration, study load and fees
The class size for group classes is 4-6 students. The duration of the course depends on the course intensity and the level. Are you not sure which language level you have? 
Contact me for a placement test. 

#### CEFR A0 - A1: True Beginner to Breakthrough Proficiency
...
|-|-|-|-|-|
|  Intensive | 6 weeks | 2 * 2 hours | 10 hours |€420|
|  Normal | 8 weeks | 2 * 1 hour | 8 hours | €280|


#### A1 - A2: Breakthrough to Elementary Proficiency
|course|duration| classes| self-study | fees|
|---|---|---|---|---|
|  Intensive | 8 weeks | 2 * 2 hours | 9 hours |€560|
|  Normal | 10 weeks | 2 * 1 hour  | 8 hours |€350|


#### A2 - B1.1: Elementary Proficiency to Beginning Intermediate Proficiency

|course|duration| classes| weekly self-study | fees|
|---|---|---|---|---|
|  Intensive | 8 weeks | 4 | 8 |€560|
|  Normal | 10 weeks | 2  | 7 |€350|


#### B1.1 - B1.2: Beginning Intermediate to Intermediate Proficiency
|course|duration| weekly classes*| self-study | fees| 
|---|---|---|---|---|---|
|  Intensive | 8 weeks | 4  | 8  | 12 | 96 |€560|
|  Normal | 10 weeks | 2  | 7  | 9 | 90 |€350|


#### B1.2 - B2.1: Intermediate to Upper Intermediate Proficiency
|course|duration| weekly classes| weekly self-study | fees |
|---|---|---|---|---|---|
|  Intensive | 12 weeks | 4 | 10 |€840|
|  Normal | 16 weeks | 2  | 8 | €560 |


#### B2.1 - B2.2: Full Upper Intermediate proficiency
|course|duration| weekly classes | weekly self-study| fees |
|---|---|---|---|---|---|
|  Intensive | 12 weeks | 4 | 9 | €840 |
|  Normal | 16 weeks | 2 | 8 | 10 | €560  |
