...
### About the Courses
The class size for group classes is 3-4 students. The duration of the course depends on the course intensity and the level. Are you not sure which language level you have? 
Contact me for a placement test. 

### Teaching method and materials
A0-A2 : De opmaat, Boom   
A2-B1 : De sprong  
B1-B2 : De finale  
...
#### A0 - A1: True Beginner to Breakthrough Proficiency
|course|duration| classes| self-study | fees |
|-|-|-|-|-|
|  Intensive | 6 weeks | 24 (2 * 2 hours per week) | 10 hours per week |€480|
|  Normal | 8 weeks | 16 (2 * 1 hour per week) | 8 hours per week | €320|

#### A1 - A2: Breakthrough to Elementary Proficiency
|course|duration| classes| self-study | fees|
|---|---|---|---|---|
|  Intensive | 8 weeks | 32 (2 * 2 hours per week) | 9 hours |€640|
|  Normal | 10 weeks | 20 (2 * 1 hour per week)  | 8 hours |€400|
